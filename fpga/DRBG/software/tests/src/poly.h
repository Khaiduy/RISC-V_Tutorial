...
#define poly_ntt_rocc KYBER_NAMESPACE(poly_ntt_rocc)
...
#define poly_invntt_rocc KYBER_NAMESPACE(poly_invntt_rocc)
void poly_invntt_rocc(poly *r);

#define poly_basemul_montgomery KYBER_NAMESPACE(poly_basemul_montgomery)
void poly_basemul_montgomery(poly *r, const poly *a, const poly *b);

#define poly_basemul_rocc KYBER_NAMESPACE(poly_basemul_rocc)
...
#define poly_add_rocc KYBER_NAMESPACE(poly_add_rocc)
void poly_add_rocc(poly *r, const poly *a, const poly *b);

#define poly_sub KYBER_NAMESPACE(poly_sub)
void poly_sub(poly *r, const poly *a, const poly *b);

#define poly_sub_rocc KYBER_NAMESPACE(poly_sub_rocc)
