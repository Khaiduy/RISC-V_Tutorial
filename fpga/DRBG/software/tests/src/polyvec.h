...
#define polyvec_ntt_rocc KYBER_NAMESPACE(polyvec_ntt_rocc)
void polyvec_ntt_rocc(polyvec *r);
...
#define polyvec_invntt_rocc KYBER_NAMESPACE(polyvec_invntt_rocc)
void polyvec_invntt_rocc(polyvec *r);

#define polyvec_basemul_acc_montgomery KYBER_NAMESPACE(polyvec_basemul_acc_montgomery)
void polyvec_basemul_acc_montgomery(poly *r, const polyvec *a, const polyvec *b);

#define polyvec_basemul_rocc KYBER_NAMESPACE(polyvec_basemul_rocc)
void polyvec_basemul_rocc(poly *r, const polyvec *a, const polyvec *b);
...
#define polyvec_add_rocc KYBER_NAMESPACE(polyvec_add_rocc)
void polyvec_add_rocc(polyvec *r, const polyvec *a, const polyvec *b);
