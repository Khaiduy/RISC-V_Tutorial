...
module TLSerdesser_1(
  ...
  HellaPeekingArbiter_Arty100TwoDDRHarness_UNIQUIFIED outArb (	// @[Serdes.scala:638:24]
    .clock                (clock),
    .reset                (reset),
  ...
  GenericSerializer_Arty100TwoDDRHarness_UNIQUIFIED outSer (	// @[Serdes.scala:640:24]
    .clock              (clock),
    .reset              (reset),
  ...
  GenericDeserializer_Arty100TwoDDRHarness_UNIQUIFIED inDes (	// @[Serdes.scala:645:23]
    .clock               (clock),
    .reset               (reset),
