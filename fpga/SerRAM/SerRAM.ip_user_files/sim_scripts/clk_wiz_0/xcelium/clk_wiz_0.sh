...
#
# Script generated by Vivado on Mon Nov 03 16:45:21 JST 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khaiduy/Workspace/RISC-V_Tutorial/fpga/SerRAM/SerRAM.cache/compile_simlib/xcelium"
  fi
