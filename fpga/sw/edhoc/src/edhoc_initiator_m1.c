...
int main(void) {
   ...
   // Static DH public key
    ...
    cred_r_len = build_ccs_credential(cred_r, "RespM3", kid_r, 1, g_r, 32, 4);
    ...
    kprintf("\r\nMethod 1: authentication (both parties)\r\n");
#endif
    ...
    ctx_i.i.ptr = i_sign_sk;
    ctx_i.i.len = 64;
    ctx_i.g_i.ptr = i_sign_pk;
