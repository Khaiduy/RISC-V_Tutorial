...
class edhoc_m3_top extends BlackBox with HasBlackBoxResource {
  ...
  // Verilog sources live in crypto-vsrc/edhoc_3/ (note: not edhoc_m3/).
  // Order: leaf modules first, top-level last.
  // ── X25519 pipeline ──────────────────────────────────────────────────────
  addResource("/crypto-vsrc/edhoc_3/ladder_rom.v")
  addResource("/crypto-vsrc/edhoc_3/mac17_dsp.v")
  addResource("/crypto-vsrc/edhoc_3/unified_modular_arith.v")
  addResource("/crypto-vsrc/edhoc_3/x25519_proc_pipeline.v")
  // ── AES-CCM ───────────────────────────────────────────────────────────────
  addResource("/crypto-vsrc/edhoc_3/aes_sbox.v")
  addResource("/crypto-vsrc/edhoc_3/aes128_core.v")
  addResource("/crypto-vsrc/edhoc_3/aes_ccm_32.v")
  // ── HMAC-SHA256 (hmac_sha/v2) ─────────────────────────────────────────────
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/fa.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/adder_64.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/csa64.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/triple_adder_64.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/ch.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/maj.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/s0_32.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/s1_32.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/SIG0_32.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/SIG1_32.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/K_ROM.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/init_ROM.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/pos_adjust.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/w_unit.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/compress.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/memory.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/sha_pad.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/sha_padding.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/sha_controller.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/sha_core.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/hmac_padding.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/hmac_controller.v")
  addResource("/crypto-vsrc/edhoc_3/hmac_sha/v2/hmac_core.v")
  // ── EDHOC protocol modules ────────────────────────────────────────────────
  addResource("/crypto-vsrc/edhoc_3/stream_formatter.v")
  addResource("/crypto-vsrc/edhoc_3/sym_controller.v")
  addResource("/crypto-vsrc/edhoc_3/protocol_coordinator.v")
  addResource("/crypto-vsrc/edhoc_3/edhoc_regmap.v")
  addResource("/crypto-vsrc/edhoc_3/edhoc_m3_top.v")
}
