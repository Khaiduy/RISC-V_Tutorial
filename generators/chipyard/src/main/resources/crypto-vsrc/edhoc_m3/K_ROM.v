// K_ROM — SHA-256 round constants (64 × 32b)
// (* rom_style = "distributed" *) forces LUTRAM inference, preventing BRAM18 use.
// Registered output preserves the original 1-cycle read latency expected by sha_controller.
module K_ROM (
    input             clk,
    input      [5:0]  addr,
    output reg [31:0] dout
);
    (* rom_style = "distributed" *) reg [31:0] K [0:63];
